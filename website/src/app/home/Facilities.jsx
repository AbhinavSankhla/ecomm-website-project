...
export default function Facilities() {
  return (
    <>
      <section className=''>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-28 mx-auto text-center w-[85%] max-w-screen-xl '>
            <div className='w-[85%] mx-auto my-10 '>
                <div className='mx-auto flex justify-center mb-6 w-[50px]'>
                ...
                <p className='mb-4 text-[19px]'>Always free shipping</p>
            ...
            <div className='w-[85%] mx-auto my-10'>
                ...
                <p className='mb-4 text-[19px]'>14 days return policy</p>
                <p className=''>Lorem ipsum dolor sit amet mauris dolor bibendum sapien</p>
            </div>
            <div className='w-[85%] mx-auto my-10'>
                <div className='mx-auto flex justify-center mb-6 w-[50px]'>
                ...
                <p className='mb-4 text-[19px]'>Quick delivery in 48h</p>
                <p className=''>Lorem ipsum dolor sit amet mauris dolor bibendum sapien</p>
            </div>
            <div className='w-[85%] mx-auto my-10'>
                <div className='mx-auto flex justify-center mb-6 w-[50px]'>
                ...
                <p className='mb-4 text-[19px]'>Online payment</p>
                <p className=''>Lorem ipsum dolor sit amet mauris dolor bibendum sapien</p>
            </div> 
        </div>
      </section>
