...
function Header() {
  ...
  return (
    <>
      <header className='bg-white shadow-lg max-w-screen-xl mx-auto '>
        <nav className='flex justify-between'>
          ...
          <div className={`group lg:static absolute bg-gray-900 lg:bg-white min-h-[100vh] lg:min-h-fit right-0 ${menuStatus == true ? 'top-0' : 'top-[-100%]'} w-[50%] lg:w-auto duration-500 lg:duration-0 border-4`}>
            {
              menuStatus == true ?
                <ul className='text-[#747474] text-[15px] p-4 flex flex-col gap-y-8 lg:hidden hover:duration-300'>
                  ...
                  <li className=''>
                    <Link className={`hover:border-b hover:border-black hover:text-black hover:${<ShopMenu />}`} href={'/shop'}>Shop</Link>
                  </li>
                  <li>
                ...
                :
                <ul className='text-black flex items-center gap-x-4 text-[15px] hover:duration-300'>
                  <li>
                    <Link className='px-3 py-2 hover:border-b hover:border-black hover:text-black active:text-white duration-300' href={'/'}>Home</Link>
                  </li>
                  <li>
                    <Link className='px-3 py-2 hover:border-b hover:border-black hover:text-black duration-300' href={'/about'}>About us</Link>
                  </li>
                  <li className="bg-green-400"
                    onMouseEnter={() => setIsHovering(true)}
                    onMouseLeave={() => setIsHovering(false)}>

                    <Link className='px-3 py-2 hover:border-b hover:border-black hover:text-black' href={'/shop'}>Shop</Link>
                  ...
                  <li>
                    <Link className='px-3 py-2 hover:border-b hover:border-black hover:text-black' href={'/contact'}>Contact</Link>
                  </li>
                </ul>
            }
