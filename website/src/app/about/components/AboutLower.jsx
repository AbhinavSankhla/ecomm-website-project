...
export default function AboutLower() {
  return (
    <>
      <section>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 w-[85%] mx-auto mt-20'>
          <div>
            ...
            <div className='border-2 border-red-500'>
              <Link href="/contact"><button class="bg-black text-white font-bold py-3 px-10 hover:opacity-80 transition-opacity duration-300 ">
              Contact with us
              </button></Link>
            </div>
          </div>
