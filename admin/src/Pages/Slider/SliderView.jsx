...
export default function SliderView() {
    ...
    const handleDelete = async (sliderId) => {
        ...
        try {
            const response = await axios.delete(`http://localhost:5200/slider/deleteSlider/${sliderId}`)
    ...
    const handleUpdate = () => {
        ...
        nav('/slider/slider-details'); //it is route so update routing pg. 
    };
                                            ...
                                            return (
                                                <tr key={i} className="bg-white border-b">
                                                    ...
                                                    <td className="px-6 py-4 space-y-2">
                                                        <img className='w-32 h-16 rounded-md object-cover' src={sliderdata.img1} alt="" />
                                                        <img className='w-32 h-16 rounded-md object-cover' src={sliderdata.img2} alt="" />
                                                        <img className='w-32 h-16 rounded-md object-cover' src={sliderdata.img3} alt="" />
                                                        <img className='w-32 h-16 rounded-md object-cover' src={sliderdata.img4} alt="" />
                                                        <img className='w-32 h-16 rounded-md object-cover' src={sliderdata.img5} alt="" />
                                                    </td>
                                                    <td className="px-6 py-4 flex gap-3 mt-6">
                                                        <button onClick={() => handleDelete(sliderdata._id)}>
                                                        ...
                                                        |
                                                        <button data-id={sliderdata._id} onClick={handleUpdate}>
